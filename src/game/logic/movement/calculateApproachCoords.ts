...
import { approachMargin } from "@/constants";

export function calculateApproachCoords(entity1: Player | Enemy, entity2: Player | Enemy) {
        ...
        const desiredDistance = Math.max(0, entity1.attackRange - approachMargin);
